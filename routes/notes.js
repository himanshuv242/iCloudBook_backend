...
router.put(
  ...
  async (req, res) => {
    ...
    if(!note) {return res.status(404).send("Not Found")}//check if note exist

    if(note.user.toString() !== req.user.id){  // to check if someone is not trying to access other user note.
